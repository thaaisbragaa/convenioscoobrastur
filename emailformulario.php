<?php
	if (isset($_POST['BTEnvia'])) {
		...
		//==================================================== 
		$email_remetente = "naoresponda@coobrasturconvenios.com.br"; // deve ser uma conta de email do seu dominio 
		//====================================================
		
		//ConfiguraÃ§Ãµes do email, ajustar conforme necessidade
		//==================================================== vantagem@coobrastur.com.br
		$email_destinatario = "email@coobrasturconvenios.com.br"; // pode ser qualquer email que receberÃ¡ as mensagens 
		//$email_destinatario = "designer@coobrastur.com.br"; // pode ser qualquer email que receberÃ¡ as mensagens 
		$email_reply = "$email_remetente"; 
		$email_assunto = "Promoção 2 Diárias Convenios"; // Este serÃ¡ o assunto da mensagem
		//====================================================
		...
		$redirect = "http://coobrasturturismo.com.br";
		...
		$sql = "INSERT INTO form_coobrasturconvenios ( nome, email, ddd, phone, gender, vacancytravel, destinationpreference, usualdestination, duration, yearround, m1, m2, m3, m4, m5, m6, m7, m8, m9, m10, m11, m12, familytravel, haskids, kids, businesstravel, frequencybstravel)
